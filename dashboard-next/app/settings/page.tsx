...
import { Bell, Globe, Key, Palette, Save, Shield } from 'lucide-react';
    ...
    <div className='space-y-6'>
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>Configure your OmniAudit preferences</p>
        </div>
        <Button>
          ...
          <CardContent className='space-y-4'>
            {[
              ...
              },
              {
                ...
                description: 'Get alerts in your Slack channel',
              },
              {
                id: 'critical',
                label: 'Critical Issues Only',
                description: 'Only notify for critical findings',
              },
